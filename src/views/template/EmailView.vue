        ...
        <div class="flex items-center p-2">
            <div class="logo-section flex justify-start items-center px-3.5">
                <IconComponent
                    ...
                    class="-ml-2 mr-2"
                />
                <img width="107" src="../../../public/img/GmailLogo.png" />
            </div>
        ...
        <div class="flex w-full justify-between">
            ...
            <div class="m-4">
                <div class="w-6 h-6 flex justify-center mb-7">
                    <img src="img/GoogleCalendar.png" alt="" class="object-center">
                </div>

                <div class="w-6 h-6 flex justify-center mb-7">
                    <img src="img/GoogleKeep.png" alt="" class="object-center">
                </div>

                <div class="w-6 h-6 flex justify-center mb-7">
                    <img src="img/GoogleTasks.png" alt="" class="object-center">
                </div>

                <div class="w-6 h-6 flex justify-center mb-7">
                    <img src="img/GoogleContacts.png" alt="" class="object-center">
                </div>
